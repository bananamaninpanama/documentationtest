...
<label for="dodeletepath" style="display: block; text-align: center; color: white; font-family: Arial; font-weight: 300; font-size: 12px;">Attempt to keep<br>current path on load?</label>
</div>`);
